...
import { DiagramModule, SymbolPaletteModule, UndoRedoService, DiagramContextMenuService, PrintAndExport, PrintAndExportService, ConnectorBridgingService } from '@syncfusion/ej2-angular-diagrams';
...
@NgModule({
  ...
  providers: [
    ...
    AuthGuard,
    CanDeactivateGuard,
    AlertService, UserService, DesignService, ConfigureSamService, PrintAndExportService, ConnectorBridgingService
