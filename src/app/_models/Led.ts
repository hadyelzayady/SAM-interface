...
import { addInfo_name, addInfo_type, ComponentType, addinfo_IP_Port, local_udp_server_port } from '../utils';
...
export class Led extends Board {
    ...
    static getObj(): NodeModel {
        return {
            ...
            addInfo: { [addInfo_name]: Led.name, [addInfo_type]: ComponentType.Software, [addinfo_IP_Port]: `clientIPPort:${local_udp_server_port}` }
        }
    }
